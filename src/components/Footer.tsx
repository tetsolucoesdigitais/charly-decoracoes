...
const Footer = () => {
  return (
    <footer className="relative bg-gradient-to-br from-charly-pink/20 via-charly-purple/20 to-charly-mint/20 border-t border-border/50">
      ...
      <div className="relative z-10">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <div className="flex items-center space-x-3 group">
                  ...
                  <span className="text-muted-foreground">(11) 9 8041-1534</span>
                </div>
                <div className="flex items-center space-x-3 group">
                  <Mail className="w-5 h-5 text-charly-purple group-hover:scale-110 transition-transform" />
                  <span className="text-muted-foreground">contato@charlydecor.com</span>
                </div>
                <div className="flex items-center space-x-3 group">
        ...
        {/* Bottom Bar */}
        <div className="border-t border-border/50 bg-background/50 backdrop-blur-lg">
