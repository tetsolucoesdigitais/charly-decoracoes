...
const Footer = () => {
  return (
    <footer className="relative bg-gradient-to-br from-black via-gray-900 to-black border-t border-charly-pink/20">
      ...
      <div className="relative z-10">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <div className="flex items-center space-x-3 group">
                  ...
                  <span className="text-gray-300">(11) 9 8041-1534</span>
                </div>
                <div className="flex items-center space-x-3 group">
                  <Mail className="w-5 h-5 text-charly-purple group-hover:scale-110 transition-transform" />
                  <span className="text-gray-300">contato@charlydecor.com</span>
                </div>
                <div className="flex items-center space-x-3 group">
        ...
        {/* Bottom Bar */}
        <div className="border-t border-charly-pink/20 bg-black/80 backdrop-blur-lg">
